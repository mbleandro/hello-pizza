"""
Django settings for hello-pizza project.
...
WSGI_APPLICATION = 'hello-pizza.wsgi.application'
...
LOGGING = {
    ...
    'handlers': {
        ...
        'file': {
            ...
            'filename': os.getenv('DJANGO_LOG_FILE', './hello-pizza.log'),
            'formatter': 'simple'
        },
    },
    'loggers': {
